...
export default {
  ...
  methods: {
    fuckMe(data){
      ...
      var width = this.$refs.chart_container.clientWidth - margin.left - margin.right
      var height = this.$refs.chart_container.clientHeight - margin.top - margin.bottom
